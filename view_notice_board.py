...
def notice():
    ...
    #Header
    header=Frame(root, bg="green", bd=0)
    header.place(x=0,y=0,width=900,height=75)

    #heading label
    nsec=Label(header, text="Karmaveer Bhaurao Patil College Vashi ",font=("Helvetica", 28,"bold"),fg="black")
    nsec.place(x=0, y=10, width=900)
    #Profile frame
    frame2=Frame(root, bg="orange")
    frame2.place(x=0,y=75,width=900,height=50)
    welcome_text = Label(frame2, text = "Search Notice Board", font=("Minion Pro Regular", 16), bg="orange")
